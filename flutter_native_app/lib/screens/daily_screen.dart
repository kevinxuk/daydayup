...
class _DailyScreenState extends State<DailyScreen> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _buildStatsRow(),
            ...grouped.entries.map((e) => _buildGroup(e, isToday)),
          ],
        ),
      ),
    );
  ...
  Widget _buildStatsRow() {
    final p = context.read<ChoreProvider>();
    return Padding(
  ...
  Widget _buildGroup(MapEntry<String, List<Task>> entry, bool isToday) {
    return Column(
      children: [
        Padding(
        ...
        Container(
          ...
          child: Column(
            children: entry.value.map((task) => _buildTaskRow(task, isToday)).toList(),
          ),
        ),
  ...
  Widget _buildTaskRow(Task task, bool isToday) {
    final p = context.read<ChoreProvider>();
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              child: Text('+¥${task.amount.toStringAsFixed(1)}',
